...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const String appTitle = 'American Explorer Travel';
    return MaterialApp(
      title: appTitle,
      home: Scaffold(
        ...
        body: const SingleChildScrollView(
          child: Column(
            children: [
              ImageSection(
                image:
                    '/home/michel/Documents/github/flutter/app_01/images/lake.jpg',
              ),
              TitleSection(
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          /*3*/
          // #docregion icon
          Icon(Icons.star, color: const Color.fromARGB(255, 244, 193, 54)),
          // #enddocregion icon
          const Text('699'),
        ],
      ),
